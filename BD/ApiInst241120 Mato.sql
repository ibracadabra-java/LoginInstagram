--------------------------------------------------------
-- Archivo creado  - martes-noviembre-24-2020   
--------------------------------------------------------
...
Insert into APIINST.METHODLIKE (ID_METHODLIKE,VELOCIDAD,MLIKE,ID_TAREA) values ('20','1','20','40');
Insert into APIINST.METHODLIKE (ID_METHODLIKE,VELOCIDAD,MLIKE,ID_TAREA) values ('21','1','21','41');
Insert into APIINST.METHODLIKE (ID_METHODLIKE,VELOCIDAD,MLIKE,ID_TAREA) values ('22','1','22','42');
...
SET DEFINE OFF;
Insert into APIINST.TAREAS (ID_TAREA,ID_TIPO_TAREA,ESTADO) values ('36','1','2');
Insert into APIINST.TAREAS (ID_TAREA,ID_TIPO_TAREA,ESTADO) values ('34','1','2');
Insert into APIINST.TAREAS (ID_TAREA,ID_TIPO_TAREA,ESTADO) values ('37','1','2');
Insert into APIINST.TAREAS (ID_TAREA,ID_TIPO_TAREA,ESTADO) values ('38','1','2');
Insert into APIINST.TAREAS (ID_TAREA,ID_TIPO_TAREA,ESTADO) values ('35','1','2');
Insert into APIINST.TAREAS (ID_TAREA,ID_TIPO_TAREA,ESTADO) values ('39','1','2');
Insert into APIINST.TAREAS (ID_TAREA,ID_TIPO_TAREA,ESTADO) values ('40','1','0');
Insert into APIINST.TAREAS (ID_TAREA,ID_TIPO_TAREA,ESTADO) values ('41','1','2');
Insert into APIINST.TAREAS (ID_TAREA,ID_TIPO_TAREA,ESTADO) values ('42','1','2');
...
PROCEDURE PRC_GET_TAREA_ESPECIFICA(
...
BEGIN
OPEN X_CURSOR FOR 
SELECT TA.ID_TAREA,MET.ID_METHODLIKE,MET.VELOCIDAD,MET.USUARIOS,ML.CANTLIKE
FROM TAREAS TA
...
--------------------------------------------------------
  ...
  ALTER TABLE "APIINST"."MASSENDING" MODIFY ("IDTAREA" NOT NULL ENABLE);
  ALTER TABLE "APIINST"."MASSENDING" MODIFY ("IDMLOGIN" NOT NULL ENABLE);
  ALTER TABLE "APIINST"."MASSENDING" MODIFY ("USUARIOS" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "APIINST"."MASSENDING" ADD CONSTRAINT "IDMLOGIN_FK" FOREIGN KEY ("IDMLOGIN")
	  REFERENCES "APIINST"."MLOGIN" ("ID_MLOGIN") ON DELETE CASCADE ENABLE;
  ALTER TABLE "APIINST"."MASSENDING" ADD CONSTRAINT "IDTAREA_FK" FOREIGN KEY ("IDTAREA")
	  REFERENCES "APIINST"."TAREAS" ("ID_TAREA") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
